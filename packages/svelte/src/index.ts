 ...
 * Source: CCS (Control Center System) Frontend
 *
 * Structure mirrors PR #7 from nuntawit:
 *   ui/       — Button, Avatar, Badge, Heading, Text, Icon, Logo, Spinner, Divider
 *   layout/   — TopNavbar, Sidebar, SidebarHeader, SidebarList, SidebarGroup, SidebarItem
 *   overlay/  — Modal, Dropdown, DropdownOption, ToastContainer
 *
 * To add components: merge PR #7 branch (feat/svelte-components) into this folder
 *
